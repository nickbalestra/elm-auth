...
var _nickbalestra$elm_auth$Main$model = {foo: 'fooBar'};
var _nickbalestra$elm_auth$Main$main = {
	main: function () {
		var elmAuthHeader = A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Elm Auth')
						])),
					A2(
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Auth like a pro')
						]))
				]));
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text(_nickbalestra$elm_auth$Main$model.foo)
						]))
				]));
	}()
};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Main'], 'Main', typeof _nickbalestra$elm_auth$Main$main === 'undefined' ? null : _nickbalestra$elm_auth$Main$main);
